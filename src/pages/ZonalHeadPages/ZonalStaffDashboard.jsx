...
export default function ZonalStaffDashboard() {
  const { allStaff, fetchAllStaff, updateStaff } = useZonalStaffStore()
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold text-nis-primary">Zonal Staff</h1>
            ...
            {filteredStaff.length === 0 ? (
              <tr>
                <td colSpan={18} className="px-4 py-8 text-center text-gray-400">
                  {allStaff.length === 0 ? "No staff records found for your zone." : "No records match your search."}
                </td>
              </tr>
            ) : (
